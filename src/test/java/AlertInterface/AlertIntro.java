...
public class AlertIntro {
    ...
    public void AlertAcceptAndGetText() {
        ...
        String actualText = alert.getText().trim(); //will get the text from pop-up that I can not inspect
        String expectedText = "I am a JS Alert";
        Assert.assertEquals(actualText, expectedText);
        alert.accept(); //will click ok, otherwise u will get UNHANDLED ALERT EXCEPTION
